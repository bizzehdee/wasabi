...
static void BSWAP(unsigned long *a) {
...
static void bfe(BLOWFISH_CTX *ctx, unsigned long *xl, unsigned long *xr) {
  unsigned long Xl=*xl;
  unsigned long Xr=*xr;
  int i=N/2;
...
static void bfd(BLOWFISH_CTX *ctx, unsigned long *xl, unsigned long *xr) {
  unsigned long Xl=*xl;
  unsigned long Xr=*xr;
...
void Blowfish_Init(BLOWFISH_CTX *ctx, unsigned char *key, int keyLen) {
  ...
  memcpy(ctx->S,ORIG_S,256*4*sizeof(unsigned long));
