...
//#include "wnd/wnds/guiobjwnd.h"	//FUCKO
...
public:
  ...
  */
  ButtonWnd(const char *button_text=NULL);
  ...
  */
  ...
  /**
    ...
    @param colorgroup The colorgroup for the bitmaps (gammagroup).
  */
  int setBitmaps(HINSTANCE hInst, int normal, int pushed, int hilited, int activated, const char *colorgroup=NULL);
  ...
  */
  ...
  /**
    ...
    @param tile Flag
  */
  void setBaseTexture(Bitmap *bmp, int x, int y, int tile=0);
  ...
  */
  void setHInstanceColorGroup(const char *_colorgroup) { colorgroup = _colorgroup; }
  ...
  */
  ...
  /**
    ...
    @param a !0, activate the button; 0, deactivate the button;
  */
  void setActivatedNoCallback(int a);
  ...
  */
  void setBorderStyle(const char *style);
...
private:
  Bitmap normalbmp, pushedbmp, hilitebmp, checkbmp, rightbmp, activatedbmp;
  Bitmap *base_texture;
