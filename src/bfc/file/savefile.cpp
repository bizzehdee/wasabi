...
// patched to work without UTF8 stuff by BU
int SaveFileWnd::getSaveFile(OSWINDOWHANDLE parent, const char *ext, const char *suggext) {
...
#if 0
int SaveFileWnd::getSaveFileW(RootWnd *parent, const char *ext, const char *suggext) {
