#ifndef _WASABI_ATTRIBUTE_H
#define _WASABI_ATTRIBUTE_H
...
// lowercase types are reserved for official SDK use
...
namespace AttributeType {
  ...
  */
  enum {
    ...
    COLOR = MK4CC('c','o','l','r'),	// attrcolor.h
  };
};
...
public:
  ...
  */
  ...
  /**
    ...
    data will be zero-terminated at data_len-1.
    Even if the data is longer than data_len.
...
private:
  String desc, default_val, *private_storage;
  CfgItemI *cfgitemi;
};
