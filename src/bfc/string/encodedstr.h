...
public:
  ...
  // Accessor inlines
  inline FOURCC getEncodingType() const { return encoding_type; }
  inline void *getEncodedBuffer() const { return encoded_buffer; }
  inline int getBufferSize() const { return buffer_size; }
  inline int getDeleteIt() const { return delete_it; }
