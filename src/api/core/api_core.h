...
/*---------------------------------------------------
  const char *core_getSupportedExtensions();
  const char *core_getExtSupportedExtensions();
  ...
  int core_getPluginData(const char *playstring, const char *name, char *data, int data_len, int data_type=0);
...
---------------------------------------------------*/
class api_core : public Dispatchable {
  public:
    const char *core_getSupportedExtensions();
    const char *core_getExtSupportedExtensions();
    CoreToken core_create();
...
inline const char *api_core::core_getSupportedExtensions() {
  return _call(API_CORE_GETSUPPORTEDEXTENSIONS, (const char *)0);
}

inline const char *api_core::core_getExtSupportedExtensions() {
  return _call(API_CORE_GETEXTSUPPORTEDEXTENSIONS, (const char *)0);
}
...
inline int api_core::core_setNextFile(CoreToken core, const char *playstring) {
...
inline const char *api_core::core_getCurrent(CoreToken core) {
  return _call(API_CORE_GETCURRENT, (const char *)0, core);
}
...
inline int api_core::core_getPluginData(const char *playstring, const char *name, char *data, int data_len, int data_type) {
...
inline void api_core::core_setCustomMsg(CoreToken core, const char *text) {
  _voidcall(API_CORE_SETCUSTOMMSG, core, text);
}

inline void api_core::core_registerExtension(const char *extensions, const char *extension_name, const char *family) {
  _voidcall(API_CORE_REGISTEREXTENSION, extensions, extension_name, family);
}

inline const char *api_core::core_getExtensionFamily(const char *extension) {
  return _call(API_CORE_GETEXTENSIONFAMILY, (const char *)0, extension);
}

inline void api_core::core_unregisterExtension(const char *extensions) {
  _voidcall(API_CORE_UNREGISTEREXTENSION, extensions);
}

inline const char *api_core::core_getTitle() {
  return _call(API_CORE_GETTITLE, (const char *)0);
}

class api_coreI : public api_core {
  public:
    virtual const char *core_getSupportedExtensions()=0;
    virtual const char *core_getExtSupportedExtensions()=0;
    virtual CoreToken core_create()=0;
    virtual int core_free(CoreToken core)=0;
    virtual int core_setNextFile(CoreToken core, const char *playstring)=0;
    virtual int core_getStatus(CoreToken core)=0;
    virtual const char *core_getCurrent(CoreToken core)=0;
    ...
    virtual int core_getPluginData(const char *playstring, const char *name, char *data, int data_len, int data_type = 0)=0;
    ...
    virtual void core_setCustomMsg(CoreToken core, const char *text)=0;
    virtual void core_registerExtension(const char *extensions, const char *extension_name, const char *family = NULL)=0;
    virtual const char *core_getExtensionFamily(const char *extension)=0;
    virtual void core_unregisterExtension(const char *extensions)=0;
    virtual const char *core_getTitle()=0;
