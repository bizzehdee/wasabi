...
class COMEXP NOVTABLE waServiceFactoryX : public waServiceFactory {
  protected:
    waServiceFactoryX() {}
  protected:
 ...
 public:
    ...
    virtual FOURCC legacy_getServiceType()=0;
    virtual GUID getServiceType()=0;
    ...
    virtual const char *getTestString()=0;
