...
public:
  ...
  static int getNumServices(GUID svc_type);
  static waServiceFactory *enumService(GUID svc_type, int n);
  ...
  static const char *getServiceTypeName(GUID svc_type);

  static void onShutdown();

  static GUID safe_getServiceType(waServiceFactory *was);
  ...
  static int isValidService(GUID svctype, waServiceFactory *service);
};
