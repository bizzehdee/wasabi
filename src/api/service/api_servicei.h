...
// services
  ...
  */
  DISPATCH(30) int legacyService_getNumServices(FOURCC svc_type);	// see api/service/svc_enum.h
  DISPATCH(31) int service_getNumServices(GUID svc_type);	
  ...
  */
  DISPATCH(40) waServiceFactory *legacyService_enumService(FOURCC svc_type, int n);
  DISPATCH(41) waServiceFactory *service_enumService(GUID svc_type, int n);
  ...
  */
  ...
  /**
    ...
    @param svc_type Service type.
  */
  DISPATCH(90) const char *legacyService_getTypeName(FOURCC svc_type);
  DISPATCH(91) const char *service_getTypeName(GUID svc_type);
...
/*[dispatchable.service_unlock.bridge]#endif // WASABI_COMPILE_COMPONENTS*/
  ...
  DISPATCH(130) int legacyService_isvalid(FOURCC svctype, waServiceFactory *service);
  DISPATCH(131) int service_isvalid(GUID svctype, waServiceFactory *service);
};
