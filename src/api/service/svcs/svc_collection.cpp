...
void svc_collectionI::addElement(const char *id, const char *includepath, int incrementalremovalid, XmlReaderParams *params) {
...
CollectionElementI::CollectionElementI(svc_collectionI *col, const char *_id, XmlReaderParams *p, int _seccount, const char *_path) {
  id = _id;
