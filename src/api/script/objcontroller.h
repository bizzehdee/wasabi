...
#define SCRIPT_FUNCTION_INIT static int __dlfid=-1, __linkcount=0; if (__cmd != NULL) return api->maki_updateDlf(__cmd, &__dlfid, &__linkcount);
...
#define SCRIPT_EXEC_EVENT0(object) { return api->maki_triggerEvent(object, DLF_ID, 0); }
#define SCRIPT_EXEC_EVENT1(object, p1) { api->maki_pushAny(p1); return api->maki_triggerEvent(object, DLF_ID, 1); }
#define SCRIPT_EXEC_EVENT2(object, p1, p2) { api->maki_pushAny(p1); api->maki_pushAny(p2); return api->maki_triggerEvent(object, DLF_ID, 2); }
#define SCRIPT_EXEC_EVENT3(object, p1, p2, p3) { api->maki_pushAny(p1); api->maki_pushAny(p2); api->maki_pushAny(p3); return api->maki_triggerEvent(object, DLF_ID, 3); }
#define SCRIPT_EXEC_EVENT4(object, p1, p2, p3, p4) { api->maki_pushAny(p1); api->maki_pushAny(p2); api->maki_pushAny(p3); api->maki_pushAny(p4); return api->maki_triggerEvent(object, DLF_ID, 4); }
#define SCRIPT_EXEC_EVENT5(object, p1, p2, p3, p4, p5) { api->maki_pushAny(p1); api->maki_pushAny(p2); api->maki_pushAny(p3); api->maki_pushAny(p4); api->maki_pushAny(p5); return api->maki_triggerEvent(object, DLF_ID, 5); }
#define SCRIPT_EXEC_EVENT6(object, p1, p2, p3, p4, p5, p6) { api->maki_pushAny(p1); api->maki_pushAny(p2); api->maki_pushAny(p3); api->maki_pushAny(p4); api->maki_pushAny(p5); api->maki_pushAny(p6); return api->maki_triggerEvent(object, DLF_ID, 6); }
#define SCRIPT_EXEC_EVENT7(object, p1, p2, p3, p4, p5, p6, p7) { api->maki_pushAny(p1); api->maki_pushAny(p2); api->maki_pushAny(p3); api->maki_pushAny(p4); api->maki_pushAny(p5); api->maki_pushAny(p6); api->maki_pushAny(p7); return api->maki_triggerEvent(object, DLF_ID, 7); }
#define SCRIPT_EXEC_EVENT8(object, p1, p2, p3, p4, p5, p6, p7, p8) { api->maki_pushAny(p1); api->maki_pushAny(p2); api->maki_pushAny(p3); api->maki_pushAny(p4); api->maki_pushAny(p5); api->maki_pushAny(p6); api->maki_pushAny(p7); api->maki_pushAny(p8); return api->maki_triggerEvent(object, DLF_ID, 8); }
#define SCRIPT_EXEC_EVENT9(object, p1, p2, p3, p4, p5, p6, p7, p8, p9) { api->maki_pushAny(p1); api->maki_pushAny(p2); api->maki_pushAny(p3); api->maki_pushAny(p4); api->maki_pushAny(p5); api->maki_pushAny(p6); api->maki_pushAny(p7); api->maki_pushAny(p8); api->maki_pushAny(p9); return api->maki_triggerEvent(object, DLF_ID, 9); }
#define SCRIPT_EXEC_EVENT10(object, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10) { api->maki_pushAny(p1); api->maki_pushAny(p2); api->maki_pushAny(p3); api->maki_pushAny(p4); api->maki_pushAny(p5); api->maki_pushAny(p6); api->maki_pushAny(p7); api->maki_pushAny(p8); api->maki_pushAny(p9); api->maki_pushAny(p10); return api->maki_triggerEvent(object, DLF_ID, 10); }

#define SCRIPT_FUNCTION_PARAMS maki_cmd *__cmd, int __vsd
#define SCRIPT_CALL NULL, -1
#define GET_SCRIPT_INT(v) api->maki_getScriptInt(v)
#define GET_SCRIPT_BOOLEAN(v) api->maki_getScriptBoolean(v)
#define GET_SCRIPT_FLOAT(v) api->maki_getScriptFloat(v)
#define GET_SCRIPT_DOUBLE(v) api->maki_getScriptDouble(v)
#define GET_SCRIPT_STRING(v) api->maki_getScriptString(v)
#define GET_SCRIPT_OBJECT(v) api->maki_getScriptObject(v)
...
scriptVar COMEXP MAKE_SCRIPT_STRING(const char *s);
...
class COMEXP ScriptObjectController : public Dispatchable {
  protected:
  ...
  public:
    ...
    const char *getAncestorClassName();
...
inline const char *ScriptObjectController::getClassName() {
  return _call(GETCLASSNAME, (const char *)NULL);
}

inline const char *ScriptObjectController::getAncestorClassName() {
  return _call(GETANCESTORCLASSNAME, (const char *)NULL);
}
...
class COMEXP ScriptObjectControllerI : public ScriptObjectController {
  public:
