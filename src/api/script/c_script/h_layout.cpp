...
void H_Layout::H_hook(ScriptObject *o) {
  ...
  if (loaded == 0) {
    ondock_id= api->maki_addDlfRef(o->vcpu_getController(), "onDock", this);
    onundock_id= api->maki_addDlfRef(o->vcpu_getController(), "onUndock", this);
    onscale_id= api->maki_addDlfRef(o->vcpu_getController(), "onScale", this);
    loaded = 1;
  }
  inited=1;
}
