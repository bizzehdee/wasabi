...
class COMEXP api_applicationX : public api_application {
  protected:
    api_applicationX() {}
  public:
    virtual const char *main_getAppName()=0;
    virtual const char *main_getVersionString()=0;
    virtual unsigned int main_getBuildNumber()=0;
    virtual GUID main_getGUID()=0;
    virtual OSTHREADHANDLE main_getMainThreadHandle()=0;
    virtual OSMODULEHANDLE main_gethInstance()=0;
    virtual const char *main_getCommandLine()=0;
    virtual void main_shutdown(int deferred = TRUE)=0;
    virtual void main_cancelShutdown()=0;
    virtual int main_isShuttingDown()=0;
    virtual const char *path_getAppPath()=0;
    virtual void path_setAppPath(const char *path)=0;
    virtual const char *path_getUserSettingsPath()=0;
    virtual const char *path_getOriginalPath()=0;
