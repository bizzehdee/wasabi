...
class COMEXP SysCallbackI : public SysCallbackX {
public:
  DISPATCH(101) FOURCC getEventType() { return syscb_getEventType(); }
  DISPATCH(200) int notify(int msg, long param1 = 0, long param2 = 0) { return syscb_notify(msg, param1, param2); }

protected:
  NODISPATCH virtual FOURCC syscb_getEventType()=0;
  NODISPATCH virtual int syscb_notify(int msg, long param1 = 0, long param2 = 0)=0;
