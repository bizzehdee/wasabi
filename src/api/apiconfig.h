...
#else
# undef WASABI_COMPILE_LINUX
#endif
#endif

#ifdef WASABI_COMPILE_DATAPUMP
# define WASABI_API_DATAPUMP    pumpApi
#endif
...
#ifdef WASABI_COMPILE_JAVASCRIPT
# include <api/javascript/api_js.h>
#endif
...
#ifdef WASABI_COMPILE_DATAPUMP
# include <api/datapump/api_pump.h>
#endif

#ifdef WASABI_MDI
extern OSWINDOWHANDLE g_mdi;
#endif

#endif // __API_DEF_CFG_H
