...
// "Wouldn't it be nice if we could use the xml stuff as just a DLL?"
#ifdef LIBXMLDLLEXP
#undef LIBXMLDLLEXP
#endif
#ifdef USE_LIBXMLDLL
# ifdef LIBXMLDLLEXPORT
#   define LIBXMLDLLEXP __declspec(dllexport)
# else//LIBXMLDLLEXPORT
#   define LIBXMLDLLEXP __declspec(dllimport)
# endif//LIBXMLDLLEXPORT
#else//USE_LIBXMLDLL
# define LIBXMLDLLEXP 
#endif//USE_LIBXMLDLL
